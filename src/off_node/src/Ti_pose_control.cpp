    ...
    else if(j == 3 || j == 5 )
    {
        ...
        if((i+1) == x1 && flag == 2 && arr[i][j])//竖
        {
            ...
            else
            {
                ...
                {
                    //向下飞 (j - -y1 + 1) * 0.5 向左飞 2 * 0.5 向上飞 (j - -y1 + 1) * 0.5 STATE-->[i+2][j]
                }
            }
        }
    }
    ...
    else//j == 2 || j == 4 || j == 6
    {
        ...
        else
        {
            if(arr[9-i][j] && (!arr[1][j]))//需要绕
            {
                ...
                if(flag = 2)//竖
                {
                    //向下 (j - y1 + 1) * 0.5 向右2 * 0.5 向上(j - y1 + 1) * 0.5
                }
            }
